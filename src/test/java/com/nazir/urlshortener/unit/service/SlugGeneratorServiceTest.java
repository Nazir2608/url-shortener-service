...
//import com.nazir.urlshortener.config.AppProperties.CacheProperties;      // ← NEW IMPORT
...
//            new CacheProperties(24, 5, "urlshortener:")              // ← ADDED
//        );
//        slugGeneratorService = new SlugGeneratorService(shortUrlRepository, props);
//    }
//
//    // ── ADDEDll existing test methods remain unchanged ──
//
//    @Nested
